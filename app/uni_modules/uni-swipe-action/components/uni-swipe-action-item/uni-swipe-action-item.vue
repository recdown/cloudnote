<template>
  ...
  <view class="uni-swipe">
    ...
    <view :change:prop="wxsswipe.showWatch" :data-disabled="disabled" :data-threshold="threshold" :prop="is_show"
          class="uni-swipe_box" @touchend="wxsswipe.touchend" @touchmove="wxsswipe.touchmove"
          @touchstart="wxsswipe.touchstart">
      <!-- #endif -->
      <!--  #ifndef MP-WEIXIN || VUE3 -->
      <view :change:prop="renderswipe.showWatch" :data-disabled="disabled+''" :data-threshold="threshold"
            :prop="is_show"
            class="uni-swipe_box" @touchend="renderswipe.touchend" @touchmove="renderswipe.touchmove"
    ...
    <view class="uni-swipe">
      <view :class="{ani:ani}" :style="{transform:moveLeft}" class="uni-swipe_box" @touchend="touchend"
            @touchmove="touchmove" @touchstart="touchstart">
        <view :class="[elClass]" class="uni-swipe_button-group button-group--left">
          <slot name="left">
            <view v-for="(item,index) in leftOptions" :key="index" :style="{
					  backgroundColor: item.style && item.style.backgroundColor ? item.style.backgroundColor : '#C7C6CD',
        ...
        <slot></slot>
        <view :class="[elClass]" class="uni-swipe_button-group button-group--right">
          <slot name="right">
            <view v-for="(item,index) in rightOptions" :key="index" :style="{
					  backgroundColor: item.style && item.style.backgroundColor ? item.style.backgroundColor : '#C7C6CD',
					  fontSize: item.style && item.style.fontSize ? item.style.fontSize : '16px'
...
<script lang="renderjs" module="renderswipe">
