  ...
  <view class="uni-data-pickerview">
    ...
    <view class="tab-c">
      <scroll-view :scroll-y="true" class="list">
        <view v-for="(item, j) in dataList[selectedIndex]" :key="j" :class="{'is-disabled': !!item.disable}"
              class="item"
              @click="handleNodeClick(item, selectedIndex, j)">
          <text class="item-text">{{ item[map.text] }}</text>
          <view v-if="selected.length > selectedIndex && item[map.value] == selected[selectedIndex].value"
                class="check"></view>
        </view>
      </scroll-view>
