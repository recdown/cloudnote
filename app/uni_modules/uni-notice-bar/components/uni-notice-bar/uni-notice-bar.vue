<template>
  <view v-if="show" :style="{ backgroundColor }" class="uni-noticebar" @click="onClick">
    <uni-icons v-if="showIcon === true || showIcon === 'true'" :color="color" :size="fontSize * 1.5"
               class="uni-noticebar-icon" type="sound"/>
    <view ref="textBox" :class="{
    ...
    >
      ...
      >
        <text :id="elId" ref="animationEle" :class="{
    ...
    <view v-if="isShowGetMore" class="uni-noticebar__more uni-cursor-point"
      ...
      <uni-icons v-else :color="moreColor" :size="fontSize * 1.1" type="right"/>
    </view>
    <view v-if="isShowClose" class="uni-noticebar-close uni-cursor-point">
      <uni-icons :color="color" :size="fontSize * 1.1" type="closeempty" @click="close"/>
    </view>
  </view>
</template>
